...
if (activeTab == 'informationTab1') {
  ...
  <li className="nav-item border border-dark rounded-top border-bottom-0">
    <button className={'nav-link' + (activeTab == 'informationTab1' ? ' active' : '')} onClick={() => setActiveTab('informationTab1')}>Tab 1</button>
  </li>
  <li className="nav-item border border-dark rounded-top border-bottom-0">
    <button className={'nav-link' + (activeTab == 'informationTab2' ? ' active' : '')}onClick={() => setActiveTab('informationTab2')}>Tab 2</button>
  </li>
  <li className="nav-item border border-dark rounded-top border-bottom-0">
    <button className={'nav-link' + (activeTab == 'informationTab3' ? ' active' : '')}onClick={() => setActiveTab('informationTab3')}>Tab 3</button>
  </li>
  <li className="nav-item border border-dark rounded-top border-bottom-0">
    <button className={'nav-link' + (activeTab == 'informationTab4' ? ' active' : '')}onClick={() => setActiveTab('informationTab4')}>Tab 4</button>
  </li>
</ul>
{tabContent}
</div>
